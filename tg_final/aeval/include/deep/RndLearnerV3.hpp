...
//    CHCs ruleManager(m_efac, z3, debug);//ToDo ilia updated
    CHCs ruleManager(m_efac, z3);
//    ruleManager.parse(smt, doElim);//ToDo ilia updated
    ruleManager.parse(smt);
...
//    ds.deferredPriorities();//ToDo ilia updated
    std::srand(std::time(0));
//    ds.synthesize(maxAttempts, doDisj);//ToDo ilia updated
