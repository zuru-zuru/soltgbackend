...
(assert 
(forall ((x Lst) (y Lst) (i Nat)) (= (mem i (append x y)) (or (mem i x) (mem i y)))) ; G-bsearch-tree-16 
)
(assert 
(forall ((x Tree) (i Nat)) (=> (tsorted x) (= (tmember x i) (mem i (content x))))) ; G-bsearch-tree-17 
)

; conjecture
(assert (not 
(forall ((x Tree) (i Nat)) (= (tcontains x i) (mem i (content x)))) ; G-bsearch-tree-18 
))
(check-sat)
