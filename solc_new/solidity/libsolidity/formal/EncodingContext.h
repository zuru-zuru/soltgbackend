...
public:
	...
	void setInvariantSolver(smtutil::SolverInterface* _solver) 
	{
		solAssert(_solver, "");
		m_invariant_solver = _solver;		
	}
	...
	void changeState();
	void changeVariable(frontend::VariableDeclaration const& _decl);
	bool changedValue(frontend::VariableDeclaration const& _decl);
	bool changedState();
	void resetChangedVariables();
	std::set<frontend::VariableDeclaration const*> m_changed_variables;
...
private:
	...
	smtutil::SolverInterface* m_invariant_solver = nullptr;
